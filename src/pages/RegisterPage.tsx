    ...
    return (
      <Layout>
        <div className="container mx-auto px-4 py-20 text-center">
          ...
          <Link
            to="/login"
            className="font-body text-sm text-foreground underline mt-6 inline-block"
          >
            Go to login
          </Link>
        </div>
  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-16 flex justify-center">
        ...
        >
          <h1 className="font-display text-3xl lg:text-4xl text-foreground text-center mb-2">
            Create Account
          </h1>
